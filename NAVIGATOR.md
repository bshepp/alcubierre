...
**Last updated:** 2026-04-20 (Session 14b — Task 2D.5d Npts=129 convergence test (§11) reveals further tempering: the strict-pass *count* at Npts=97 (6818/10080) is over-estimated; corrected estimate is ~5900/10080, with 47% of boundary points flipping pass→fail at higher resolution. The existence claim survives (deep-pass region is robust); the count-and-boundary are resolution-sensitive. Combined with Session 14a §9 ("all wall, no interior") and §10 ("dense not sparse polynomial boundary"), the cumulative tempering of the Session 11 result is substantial. See [`FELL_HEISENBERG_SWEEP_NOTES.md`](FELL_HEISENBERG_SWEEP_NOTES.md) §9, §10, §11.).
